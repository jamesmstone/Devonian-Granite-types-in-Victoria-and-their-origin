...
\item Mol. \ce{Al2O3} / \ce{( Na2O + K2O + CaO)} \textless 1.1 on the Aluminium Saturation Index, see Figure  ~\ref{fig:AluminiumSaturationIndex}.
\end{itemize}
...
\item Mol. \ce{Al2O3} / \ce{ ( Na2O + K2O + CaO)} \textgreater 1.1 on the Aluminium Saturation Index, see Figure  ~\ref{fig:AluminiumSaturationIndex}.
\end{itemize}
\cite{chappell2001two}
